  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute top-0 left-1/2 bottom-0 w-px opacity-20 pointer-events-none"
          style={{ backgroundColor: '#b4a35d' }}
        />

        {/* Left side content */}
        <div className="absolute left-0 top-0 w-full md:w-1/2 h-full flex flex-col justify-between p-8 md:p-12 z-10">
          {/* Top left: mini logo area */}
          <div className="space-y-8">
            <div className="w-12 h-12 rounded-full border-2" style={{ borderColor: '#bfbea2' }} />
        ...
        <div className="absolute right-0 top-0 w-full md:w-1/2 h-full flex flex-col justify-center items-start md:items-center p-8 md:p-12 z-20">
