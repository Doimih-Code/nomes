...
export default function CheckoutAnulatPage() {
          ...
          {loaded && (
            ...
            >
              ...
              <div
                ...
                style={{ borderColor: 'rgba(238, 229, 200, 0.2)', backgroundColor: 'rgba(238, 229, 200, 0.06)' }}
              >
                <svg
                  width="28"
                  height="28"
              ...
              <div>
                ...
                >
                  Nu a fost procesată nicio plată. Poți reveni oricând la cursuri pentru a finaliza achiziția.
                </p>
              </div>
